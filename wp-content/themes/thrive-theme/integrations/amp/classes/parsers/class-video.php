...
class Video {
	...
	public static function parse_videos( $dom ) {
		$video_nodes = DOM_Helper::get_all_nodes_for_tag_and_class( 'div', static::VIDEO_CLASS, $dom );
	...
	public static function get_type_from_iframe( $video_container ) {
		return static::get_iframe_node( $video_container )->getAttribute( 'data-provider' );
	}
