...
class Main {
	...
	public static function is_css_valid() {
		return (int) strlen( static::get_styles() ) / 1000 < 75;
	}
	...
	public static function get_styles() {
		/* this can be called from non-amp locations. In that scenario, initialize the content if it wasn't initialized yet */
		if ( empty( static::$content ) ) {
			static::initialize_content();
		}
